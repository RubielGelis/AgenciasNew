...
*/		
			...
			BEGIN
				...
				SET @ds_RespuestaJOB = 'La resolucion: ' + @ds_num_resolucion + ' esta Vencida. Verficar parametrizacion en el maestro de resoluciones o los datos de resolución de la sucursal e implante.';
				RETURN 1 
			END 
