...
const AVAILABLE_FIELDS: { key: string; label: string; group: string }[] = [
    ...
    { key: 'destinoCabecera', label: 'Destino (Cabecera)', group: 'Cabecera' },
    { key: 'fechaInicioCabecera', label: 'Fecha Inicio (Cabecera)', group: 'Cabecera' },
    { key: 'fechaFinCabecera', label: 'Fecha Fin (Cabecera)', group: 'Cabecera' },
    { key: 'pasajeroCabecera', label: 'Pasajero Principal (Cabecera)', group: 'Cabecera' },
    { key: 'paxAdultosCabecera', label: 'Cantidad Adultos (Cabecera)', group: 'Cabecera' },
    { key: 'paxNinosCabecera', label: 'Cantidad Niños (Cabecera)', group: 'Cabecera' },
    { key: 'reservacionCabecera', label: 'Reservación / Localizador (Cabecera)', group: 'Cabecera' },
    { key: 'descripcionManualCabecera', label: 'Descripción Manual (Cabecera)', group: 'Cabecera' },
